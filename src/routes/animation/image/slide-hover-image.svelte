<script lang="ts">
	import frierenCat2 from '$lib/assets/images/frieren-cat-2.jpeg';
  ...
  <figure class="group relative overflow-hidden">
	<img
		...
		src={frierenCat2}
		alt="Feren and Stark in cat form, Frieren fan art"
	/>
	<figcaption
		class={cn([
...
<figure class="group relative overflow-hidden">
	...
	>
		...
		<Dialog.Root>
			<Dialog.Trigger class=" font-bold text-blue-300 underline">See Code</Dialog.Trigger>
			<Dialog.Content class=" max-w-max">
				<Dialog.Header>
					<Dialog.Title>Component Code</Dialog.Title>
					<Dialog.Description>
						<p>When you close this dialog, you will see the picture position is changed.</p>
						<p>
							This is because this dialog change the dom structure hence what the image is relative
							to when positioning.
						</p>
						<Script {code} />
					</Dialog.Description>
